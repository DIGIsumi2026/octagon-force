...
const services = [
  ...
  },
  {
    ...
    description:
      "High-risk cash-in-transit operations handled by trained security teams, secure procedures, specialized vehicles, and dependable operational coordination.",
  },
  {
      ...
      <div className="container">
        ...
        <div className="services-showcase-grid">
          {services.map((service, index) => {
            ...
            const startX =
              columnOffset === 0 ? -90 : columnOffset === 1 ? 0 : 90;
            const startRotate =
              columnOffset === 0 ? -7 : columnOffset === 1 ? 3 : 7;
